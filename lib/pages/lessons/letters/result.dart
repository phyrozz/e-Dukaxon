...
// import 'package:e_dukaxon/pages/lessons/letters/score_dialog.dart';
...
class _LettersResultPageState extends State<LettersResultPage> {
  ...
  void initState() {
    ...
    getPrefValues()
      ...
      updateAccumulatedScoresAndLessonTakenCounter(widget.lessonName)
          .then((_) => addCounterOnLesson(widget.lessonName))
          .then((_) {
        // Timer(const Duration(milliseconds: 500), () {
        //   // _showScoreDialog();
        // });
        // Close the ScoreDialogPopUp after 4 seconds
  ...
  //       return ScoreDialogPopUp(
  //         score: finalScore,
  //         scoreAdd: score,
  //         streakMultiplier: dailyStreak,
