  ...
  void getLevelDataByName(String lessonName) async {
    ...
    try {
      ...
      if (lesson != null) {
        ...
        List<String> randomSounds = [];
        for (var i = 0; i < 4; i++) {
          randomSounds.add(shuffleList[i]);
        }
        ...
        if (mounted) {
          setState(() {
            ...
            // Replace one of the random sounds with the correct answer sound
            randomSounds[Random().nextInt(randomSounds.length)] =
                        ...
                        Navigator.pushReplacement(
                          ...
                          MaterialPageRoute(
                              builder: (context) => LettersLevelThree(
                                  lessonName: widget
                                      .lessonName)), // Replace `NextPage` with the actual next page widget
                        );
                      },
