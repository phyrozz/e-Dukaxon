...
class _LetterTracingPageState extends State<LetterTracingPage> {
  ...
  void initState() {
    super.initState();
    getLanguage();
    currentlyTracedLetter = getRandomLetter();
    _strokes.add([]);
    setState(() {
      levelDescription = "Please trace the letter '$currentlyTracedLetter'.";
      answers.add(currentlyTracedLetter);
      isLoading = false;
    });
  }
